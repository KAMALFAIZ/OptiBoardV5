"""
Crée les menus Comptabilité dans la DB CENTRALE (sans X-DWH-Code)
pour qu'ils soient visibles par TOUS les clients.
Le parent Comptabilité en central est id=714.
"""
import requests, json, re, hashlib, time

BASE = "http://localhost:8084/api"
# SANS DWH code -> écrit en DB centrale
H = {"Content-Type": "application/json"}

PARENT_ID = 714  # Comptabilite folder ID in CENTRAL DB
...
print("\n=== Sous-dossier: Tableaux de Bord Comptabilite (CENTRAL) ===")
...
print("\n=== Sous-dossier: Analyses Comptables (CENTRAL) ===")
...
print("\n=== Sous-dossier: Registres Comptables (CENTRAL) ===")
